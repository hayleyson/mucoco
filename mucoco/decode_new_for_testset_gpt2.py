...
def main(args):
    ...
    if source_dataset is None:
        ...
        init_gen_ids = joblib.load('/scratch/x2600a03/mucoco/outputs/toxicity/save-init-gen-all-uniform/testset_FINAL_gpt2_input_ids.pkl')
        source_dataset = joblib.load('/scratch/x2600a03/mucoco/outputs/toxicity/save-init-gen-all-uniform/testset_FINAL_gpt2_texts.pkl')
        ##
