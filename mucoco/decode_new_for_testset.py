...
def main(args):
    ...
    if source_dataset is None:
        ...
        init_gen_ids = joblib.load('/scratch/x2600a03/mucoco/outputs/toxicity/save-init-gen-all-uniform/testset_FINAL_jigsaw_input_ids.pkl')
        source_dataset = joblib.load('/scratch/x2600a03/mucoco/outputs/toxicity/save-init-gen-all-uniform/testset_FINAL_jigsaw_texts.pkl')
        ##
    ...
    for text_id, source_text in enumerate(source_dataset):
        ...
        if len(source_batch) == batch_size: #this is just one for now, greater than 1 batch size will not work
            ...
            AR_predicted_indices = init_gen_ids[text_id]
