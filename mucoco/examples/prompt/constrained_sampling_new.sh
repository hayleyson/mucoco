...
SENTIMENTMODEL5CLASS=/projects/tir5/users/sachink/embed-style-transfer/models/roberta-base-5class-sst-2-with-gpt2-large-embeds/checkpoint_best
SENTIMENTMODEL3CLASS=/projects/tir5/users/sachink/embed-style-transfer/models/roberta-base-3class-sst-2-with-gpt2-large-embeds/checkpoint_best
...
SENTIMENTMODEL=/projects/tir5/users/sachink/embed-style-transfer/models/roberta-base-textattack-pretok-sst-2-with-gpt2-large-embeds/checkpoint_best
SENTIMENTMODEL1=/projects/tir5/users/sachink/embed-style-transfer/models/roberta-base-textattack-posvsother-sst-2-with-gpt2-large-embeds/checkpoint_best
SENTIMENTMODEL2=/projects/tir5/users/sachink/embed-style-transfer/models/roberta-base-textattack-posvsother-pretok-sst-2-with-gpt2-large-embeds/checkpoint_best
SENTIMENTMODEL3=/projects/tir5/users/sachink/embed-style-transfer/models/roberta-base-textattack-negvsother-sst-2-with-gpt2-large-embeds/checkpoint_best
SENTIMENTMODEL4=/projects/tir5/users/sachink/embed-style-transfer/models/roberta-base-textattack-negvsother-pretok-sst-2-with-gpt2-large-embeds/checkpoint_best

# SENTIMENTMODEL2=/projects/tir5/users/sachink/embed-style-transfer/models/roberta-base-textattack-very-sst-2-with-gpt2-large-embeds/checkpoint_best/

POLITENESSMODEL=/projects/tir5/users/sachink/embed-style-transfer/models/roberta-base-3class-politeness-with-gpt2-large-embeds/checkpoint_best
...
then
    ...
    OUTPUTLEN=20
    MAXLEN=20
    sentmodel=SENTIMENTMODEL${SENTIMENTMODELID}
    echo ${!sentmodel}
    ...
    noise_variance=1.0
    embedgd_do_sample="false"
elif [[ "$option" == "positive-neutral-5class" ]]
then
    echo "positive-neutral"
    OPTIMSTEPS=250
    DATASTYLE="jsonl"
    ...
    JSON_SKEY="text"
    NUM_SAMPLES=25  
    model=$PRIMARYMODEL:$SENTIMENTMODEL5CLASS
    tokenizer=$PRIMARYMODEL:$SENTIMENTMODEL5CLASS
    model_types=AutoModelForCausalLM:RobertaCustomForSequenceClassification
    betas=0.8:0.2
    loss=gpt2:classification2in5
    label_id=0:4
    lossabbr="pyx:2in5class"
    selection_criterion="mrr_allsat"
    epsilons=$CLASSLOGPROB
    min_epsilons=$CLASSLOGPROB
    epsilon_warmup_steps=0
    ...
    noise_variance=1.0
    embedgd_do_sample="false"
elif [[ "$option" == "positive-neutral-3class" ]]
then
    echo "positive-neutral"
    OPTIMSTEPS=250
    DATASTYLE="jsonl"
    ...
    JSON_SKEY="text"
    NUM_SAMPLES=25  
    model=$PRIMARYMODEL:$SENTIMENTMODEL3CLASS
    tokenizer=$PRIMARYMODEL:$SENTIMENTMODEL3CLASS
    model_types=AutoModelForCausalLM:RobertaCustomForSequenceClassification
    betas=0.8:0.2
    loss=gpt2:classification1in3
    label_id=0:2
    lossabbr="pyx:1in3class"
    selection_criterion="mrr_allsat"
    epsilons=$CLASSLOGPROB
    min_epsilons=$CLASSLOGPROB
    epsilon_warmup_steps=0
    ...
    noise_variance=1.0
    embedgd_do_sample="false"
elif [[ "$option" == "politeness-1in3class" ]]
then
    echo "politeness-neutral"
    DATASTYLE="jsonl"
    ...
    MAXLEN=20
    OPTIMSTEPS=250
    model=$PRIMARYMODEL:$POLITENESSMODEL:$POLITENESSMODEL
    tokenizer=$PRIMARYMODEL:$POLITENESSMODEL:$POLITENESSMODEL
    model_types=AutoModelForCausalLM:RobertaCustomForSequenceClassification:RobertaCustomForSequenceClassification
    betas=0.8:0.2:0
    loss=gpt2:classificationlogits1inN:classificationlogits1inN
    label_id=0:6:7
    lossabbr="pyx:0le1:0le2"
    selection_criterion="mrr_allsat"
    ...
    noise_variance=1.0
    embedgd_do_sample="false"
elif [[ "$option" == "negative-neutral-5class" ]]
then
    ...
    noise_variance=1.0
    embedgd_do_sample="false"
elif [[ "$option" == "negative-neutral-1in5class" ]]
then
    echo "negative-neutral"
    OPTIMSTEPS=250
    DATASTYLE="jsonl"
    ...
    JSON_SKEY="text"
    NUM_SAMPLES=25  
    model=$PRIMARYMODEL:$SENTIMENTMODEL5CLASS:$SENTIMENTMODEL5CLASS:$SENTIMENTMODEL5CLASS:$SENTIMENTMODEL5CLASS
    tokenizer=$PRIMARYMODEL:$SENTIMENTMODEL5CLASS:$SENTIMENTMODEL5CLASS:$SENTIMENTMODEL5CLASS:$SENTIMENTMODEL5CLASS
    model_types=AutoModelForCausalLM:RobertaCustomForSequenceClassification:RobertaCustomForSequenceClassification:RobertaCustomForSequenceClassification:RobertaCustomForSequenceClassification
    betas=0.8:0.2:0:0:0
    loss=gpt2:classificationlogits1inN:classificationlogits1inN:classificationlogits1inN:classificationlogits1inN
    label_id=0:1:2:3:4
    lossabbr="pyx:0le1:0le2:0le3:0le4"
    selection_criterion="mrr_allsat"
    ...
    noise_variance=1.0
    embedgd_do_sample="false"
elif [[ "$option" == "negative-neutral-2in5class" ]]
then
    echo "negative-neutral"
    OPTIMSTEPS=250
    DATASTYLE="jsonl"
    ...
    JSON_SKEY="text"
    NUM_SAMPLES=25  
    model=$PRIMARYMODEL:$SENTIMENTMODEL5CLASS:$SENTIMENTMODEL5CLASS:$SENTIMENTMODEL5CLASS
    tokenizer=$PRIMARYMODEL:$SENTIMENTMODEL5CLASS:$SENTIMENTMODEL5CLASS:$SENTIMENTMODEL5CLASS
    model_types=AutoModelForCausalLM:RobertaCustomForSequenceClassification:RobertaCustomForSequenceClassification:RobertaCustomForSequenceClassification
    betas=0.8:0.2:0:0
    loss=gpt2:classificationlogits1inN:classificationlogits1inN:classificationlogits1inN
    label_id=0:2:3:4
    lossabbr="pyx:0le2:0le3:0le4"
    selection_criterion="mrr_allsat"
    epsilons=$CLASSLOGPROB:$CLASSLOGPROB:$CLASSLOGPROB
    min_epsilons=$CLASSLOGPROB:$CLASSLOGPROB:$CLASSLOGPROB
    epsilon_warmup_steps=0:0:0
    epsilon_cooldown_steps=1:1:1
    epsilon_decay_functions=step:step:step
    LAMBDALR=0.1
    noise_variance=1.0
    embedgd_do_sample="false"
elif [[ "$option" == "negative-neutral-1in3class" ]]
then
    echo "negative-neutral"
    OPTIMSTEPS=250
    DATASTYLE="jsonl"
    ...
    JSON_SKEY="text"
    NUM_SAMPLES=25  
    model=$PRIMARYMODEL:$SENTIMENTMODEL3CLASS:$SENTIMENTMODEL3CLASS
    tokenizer=$PRIMARYMODEL:$SENTIMENTMODEL3CLASS:$SENTIMENTMODEL3CLASS
    model_types=AutoModelForCausalLM:RobertaCustomForSequenceClassification:RobertaCustomForSequenceClassification
    betas=0.8:0.2:0
    loss=gpt2:classificationlogits1inN:classificationlogits1inN
    label_id=0:1:2
    ...
    noise_variance=1.0
    embedgd_do_sample="false"
elif [[ "$option" == "positive-neutral-1in3class" ]]
then
    echo "positive-neutral"
    OPTIMSTEPS=250
    DATASTYLE="jsonl"
    ...
    noise_variance=1.0
    embedgd_do_sample="false"
elif [[ "$option" == "unique-positive-neutral" ]]
then
    echo "unique-positive-neutral"
    UNIQUELOGPROB=-6.0
    OPTIMSTEPS=250
    DATASTYLE="jsonl"
    DATAFILE=$DATA_DIR/control-prompts/sentiment_prompts-10k/neutral_prompts.jsonl
    ...
    JSON_SKEY="text"
    NUM_SAMPLES=25  
    model=$PRIMARYMODEL:$SENTIMENTMODEL:$PRIMARYMODEL
    tokenizer=$PRIMARYMODEL:$SENTIMENTMODEL:$PRIMARYMODEL
    model_types=AutoModelForCausalLM:RobertaCustomForSequenceClassification:AutoModelForCausalLM
    betas=0.8:0.2:0.0
    loss=gpt2:classificationlogits:unique
    label_id=0:1:0
    lossabbr="pyx:binary:unique"
    selection_criterion="mrr_allsat"
    epsilons=$CLASSLOGPROB:$UNIQUELOGPROB
    min_epsilons=$CLASSLOGPROB:$UNIQUELOGPROB
    epsilon_warmup_steps=0:0
    epsilon_cooldown_steps=1:1
    ...
    embedgd_do_sample="false"
    echo $epsilons
elif [[ "$option" == "unique-negative-neutral" ]]
then
    echo "unique-negative-neutral"
    UNIQUELOGPROB=-6.0
    OPTIMSTEPS=250
    DATASTYLE="jsonl"
    DATAFILE=$DATA_DIR/control-prompts/sentiment_prompts-10k/neutral_prompts.jsonl
...
then
    ...
    model_types=AutoModelForCausalLM:AutoModelForCausalLM
    betas=0.5:0.5
    loss=gpt2:keywordclassification2
    label_id=0:0
    lossabbr="pyx:dist"
    selection_criterion="mrr_allsat"
    epsilons=$CLASSLOGPROB
...
then
    ...
    betas=0.5:0.5:0.0
    loss=gpt2:keywordclassification2:unique
    label_id=0:0:0
    lossabbr="pyx:dist:dist2"
    selection_criterion="mrr_allsat"
    epsilons=$CLASSLOGPROB:-6
    min_epsilons=$CLASSLOGPROB:-6
    epsilon_warmup_steps=0:0
    epsilon_cooldown_steps=1:1
    epsilon_decay_functions=linear:linear
    LAMBDALR=1.0
...
then
    ...
    model_types=AutoModelForCausalLM:AutoModelForCausalLM:AutoModelForCausalLM:AutoModelForCausalLM:AutoModelForCausalLM
    betas=0.2:0.4:0.4:0.0:0.0
    loss=gpt2:ngramsblacklist:ngramsblacklist:ngramsblacklist:ngramsblacklist
    label_id=0:0:0:0:0
    lossabbr="pyx:dist1:dist2:dist3:dist4"
    epsilons=$CLASSLOGPROB:$CLASSLOGPROB:$CLASSLOGPROB:$CLASSLOGPROB
    min_epsilons=$CLASSLOGPROB:$CLASSLOGPROB:$CLASSLOGPROB:$CLASSLOGPROB
...
then
    ...
    model_types=AutoModelForCausalLM:AutoModelForCausalLM:AutoModelForCausalLM:AutoModelForCausalLM:AutoModelForCausalLM:AutoModelForCausalLM
    betas=0.2:0.4:0.4:0.0:0.0:0.0
    loss=gpt2:ngrams:ngrams:ngrams:ngrams:unique
    label_id=0:0:0:0:0:0
