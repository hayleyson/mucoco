...
from laser_edit.edit.ebm.losses.base_loss import BaseLoss
from laser_edit.edit.ebm.losses.model_wrapper import ModelWrapper
...
for file in os.listdir(losses_dir):
    ...
    if (
        ...
        module = importlib.import_module("laser_edit.edit.ebm.losses." + loss_name)
