...
from laser_edit.utils.utils import read_outputs, ravel


device = torch.device("cuda") if torch.cuda.is_available() else torch.device("cpu")

# MEMO
# - toxicity valid dataset: laser_edit/ebm_training/data/toxicity/jigsaw-unintended-bias-in-toxicity-classification/fine-grained/valid.jsonl
# - nli valid dataset: laser_edit/ebm_training/data/nli/snli_mnli_anli_train_dev_with_finegrained.jsonl
