...
#SBATCH --gres=gpu:1
#SBATCH --output='laser_edit/_slurm_outs/toxicity_model_%j.out'
#SBATCH --nodelist=n01
...
# srun accelerate launch --num_processes=4 laser_edit/ebm_training/toxicity/train_energy_model_v2_resume.py \
...
srun accelerate launch --num_processes=1 laser_edit/ebm_training/toxicity/train_energy_model_v2_resume.py \
--model=roberta-base-custom \
--model_type=RobertaCustomForSequenceClassification \
--batch_size=56 \
--num_epochs=3 \
