...
# with open('/home/hyeryung/data/mucoco/laser_edit/_notebooks/utils_merge_uubg_uh00.txt', 'w') as f:
#     f.writelines([x + '\n' for x in res_merged])

# import pandas as pd

# res_merged = pd.read_json('/home/hyeryung/data/mucoco/laser_edit/_notebooks/utils_merge_uubg_uh00.txt', lines=True)
# devset = pd.read_json('/home/hyeryung/data/mucoco/laser_edit/data/toxicity-avoidance/dev_set.jsonl', lines=True)
