...
def evaluate_all_results(
    ...
    for pred_file in prediction_files:
        ...
        if 'toxicspans_extended' in pred_file.name:
            ...
            original_file = 'laser_edit/data/BIG-Bench-Mistake/logical_deduction.jsonl'
        elif 'tracking_shuffled_objects' in pred_file.name:
            task = 'tracking_shuffled_objects'
            original_file = 'laser_edit/data/BIG-Bench-Mistake/tracking_shuffled_objects.jsonl'
        else:
