...
file_save_path='/home/hyeryung/data/mucoco/laser_edit/llm_experiments/baselm_gens/llama3_8b_instruct/nontoxic/editing/llama3_8b_editing_gpt2_gens_all_nontoxic.jsonl'
data = pd.read_json(file_save_path, lines=True)


with open('laser_edit/data/toxicity-avoidance/testset_gpt2_2500.jsonl','r') as f:
