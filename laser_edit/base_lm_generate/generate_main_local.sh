...
#SBATCH --output='/home/hyeryung/data/mucoco/laser_edit/base_lm_generate/logs/%j.out'
...
FILE_SAVE_DIR=laser_edit/data/nli-toxicity/
# nli: /home/hyeryung/data/mucoco/laser_edit/data/logical-consistency/anli-r2-test_premises.jsonl
# nontoxic: /home/hyeryung/data/mucoco/laser_edit/data/toxicity-avoidance/nontoxic_prompts-250.jsonl
# rewrite_hypothesis_toxic: /home/hyeryung/data/mucoco/laser_edit/data/nli-toxicity/snli_anli_test_contradictory_samples_500.jsonl
INPUT_FILE_PATH=laser_edit/data/nli-toxicity/snli_anli_test_contradictory_samples_500.jsonl
NUM_TEST_PROMPTS=-1
...
srun -n 1 -c 1 python /home/hyeryung/data/mucoco/laser_edit/base_lm_generate/generate_main.py \
--model $MODEL_NAME \
