...
#SBATCH --array=0-3%1
#SBATCH --output='/home/hyeryung/data/mucoco/laser_edit/base_lm_generate/logs/%A_%a.out'
...
# --- Shared defaults ---
MAX_NEW_TOKENS=4096
GEN_PY="${ROOT_DIR}/laser_edit/base_lm_generate/generate_main.py"
...
configure_prompt_type() {
  ...
  case "$pt" in
    nli_nontoxic_*|nli+nontoxic_*)
      TASK=nli_nontoxic
      INPUT_FILE_PATH="${ROOT_DIR}/laser_edit/data/nli-toxicity/nontoxic-prompts-toxic-continuations.jsonl"
      ;;
    nli_*)
      TASK=nli
      INPUT_FILE_PATH="${ROOT_DIR}/laser_edit/data/logical-consistency/anli-r2-test_premises.jsonl"
      ;;
    nontoxic_*)
      TASK=nontoxic
      INPUT_FILE_PATH="${ROOT_DIR}/laser_edit/data/toxicity-avoidance/nontoxic_prompts-250.jsonl"
      ;;
    comment_*)
      TASK=comment
      INPUT_FILE_PATH="${ROOT_DIR}/laser_edit/data/nli-toxicity/socc_gnm_top250_ncomments_10sampled_root_comments.jsonl"
      ;;
...
FILE_SAVE_DIR="${ROOT_DIR}/laser_edit/base_lm_generate/baselm_gens/${MODEL_NAME##*/}/${TASK}"
