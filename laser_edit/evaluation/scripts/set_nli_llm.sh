...
#SBATCH --job-name=eval_setnli_llm
#SBATCH --output='laser_edit/_slurm_outs/eval_set_nli_llm_%j.out'

# Evaluate set-NLI (Set-SNLI) LLM-edit outputs (Plain / Self-locate / LaSEr-LLM JSONL).
...
GENERATIONS_FILE_PATH="${ROOT}/outputs/sc_energy/set_nli/llm/testset_incon_300/set_nli_qwen2.5-7b-instruct_w_ebm_locate_edit_result.jsonl"
