...
#SBATCH --job-name=eval_lconvqa_ebm
#SBATCH --output='laser_edit/_slurm_outs/eval_set_lconvqa_ebm_%j.out'

# Evaluate set-LConVQA LaSEr-EBM Edit outputs.txt (no --set_consistency_llm_edit_output).
...
GENERATIONS_FILE_PATH="${ROOT}/outputs/sc_energy/set_lconvqa/ebm/<wandb_id>/outputs.txt"
