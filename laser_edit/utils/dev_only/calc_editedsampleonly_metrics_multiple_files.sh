...
# RESULT_PATHS_CSV=/home/hyeryung/data/mucoco/laser_edit/utils/input/nli_result_paths.csv
...
# srun -n 1 -c 1 python /home/hyeryung/data/mucoco/laser_edit/utils/calc_editedsampleonly_metrics_multiple_files.py \
#   --output_files "${OUTPUT_FILES[@]}" \
#   --index_files /home/hyeryung/data/mucoco/laser_edit/data/logical-consistency/anli-r2-test_prompt_4_edit_candidates_0_48.indexes_in_3105.txt \
#   --nicknames th0.48 \
#   --task nli \
