...
class GPT():
    def __init__(self, params):
        ...
        if "gpt" in params['baseline']['model'].lower():
            self.client = OpenAI(api_key = private_key,
    ...
    def api_call(self, prompt: str) -> str:
        ...
        # Total tokens generated by the model (reasoning + final output)
        total_generated_tokens = completion.usage.completion_tokens
        ...
        return completion.choices[0].message.content.strip(), reasoning_tokens, total_generated_tokens
