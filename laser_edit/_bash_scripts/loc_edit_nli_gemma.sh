...
# --source_data 'laser_edit/data/logical-consistency/gemma/filtered_0.99_r2-test_500_gemma-2-2b-it_49577.jsonl' \
...
# --task nli \
# --output_dir_prefix 'outputs/nli/' \
# --source_data 'laser_edit/data/logical-consistency/gemma/filtered_0.9_r2-test_500_gemma-2-2b-it_49577.jsonl' \
# --source_style 'inconsistent' \
# --target_style 'consistent' \
# --target_label_ids 1 1 \
# --thresholds 0.9 \
