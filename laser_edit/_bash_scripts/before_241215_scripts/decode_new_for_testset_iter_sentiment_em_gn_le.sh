...
#SBATCH --nodelist=n01
#SBATCH --gres=gpu:1
#SBATCH --output='laser_edit/_slurm_outs/s_gbi_em_gn_%j.out'
...
srun python laser_edit/decode_new_for_testset_iter.py \
 ...
 --dampness=0.1\
 --data='/home/hyeryung/data/mucoco/laser_edit/data/sentiment/dev_set.jsonl'\
 --datastyle='jsonl'\
 ...
 --optim='embedgd_le'\
 --optim-steps=20\
 --output_dir_prefix='outputs/sentiment/mucola-le'\
 --output-style='jsonl'\
 --prefix-length=0\
 --random-example='true'\
