...
#SBATCH --partition=P1
#SBATCH --gres=gpu:1
#SBATCH --output='laser_edit/_slurm_outs/t_gbi_mucola_em_%j.out'
...
srun python laser_edit/decode_new_for_testset_iter.py \
 --AR-temperature=1.0\
 --AR-top-k=0\
 --AR-top-p=0.96\
 ...
 --dampness=0.1\
 --data='laser_edit/data/toxicity-avoidance/testset_gpt2_2500.jsonl'\
 --datastyle='jsonl'\
 ...
 --metric='l2'\
 --thresholds='-3'\
 --model='gpt2-large:/shared/s3/lab07/hyeryung/loc_edit/roberta-base-jigsaw-toxicity-classifier-with-gpt2-large-embeds-energy-training/step_2800_best_checkpoint/'\
 --model_dtype='fp32'\
 ...
 --optim='embedgd_le'\
 --optim-steps=200\
 --output_dir_prefix='outputs/toxicity/roberta-base-jigsaw-toxicity-classifier-with-gpt2-large-embeds-energy-training'\
 --output-style='jsonl'\
 --prefix-length=0\
 --random-example='true'\
 ...
 --suffix-length=0\
 --target-type='embeds'\
 --tokenizer='gpt2-large:/shared/s3/lab07/hyeryung/loc_edit/roberta-base-jigsaw-toxicity-classifier-with-gpt2-large-embeds-energy-training/step_2800_best_checkpoint/'\
 --topic-target='none'\
