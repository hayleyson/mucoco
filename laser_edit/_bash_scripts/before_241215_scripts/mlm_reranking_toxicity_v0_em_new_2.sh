...
--task toxicity \
--num_samples 10 \
--source_data 'laser_edit/data/toxicity-avoidance/dev_set.jsonl' \
--source_style 'toxic' \
--target_style 'nontoxic' \
--target_label_ids 0 0 0 \
--thresholds 0.9 0.9 \
--wandb_project 'toxicity-decoding' \
--model_paths 'gpt2-large' '/home/hyeryung/data/loc_edit/models/roberta-base-jigsaw-toxicity-classifier-energy-training/step_1000_best_checkpoint' 'cointegrated/roberta-large-cola-krishna2020' \
--tokenizer_paths 'gpt2-large' '/home/hyeryung/data/loc_edit/models/roberta-base-jigsaw-toxicity-classifier-energy-training/step_1000_best_checkpoint' 'cointegrated/roberta-large-cola-krishna2020' \
