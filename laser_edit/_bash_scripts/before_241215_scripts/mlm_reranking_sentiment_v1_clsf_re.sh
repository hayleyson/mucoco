...
#SBATCH --gres=gpu:1
#SBATCH --output='laser_edit/_slurm_outs/s_bv1_clsf_%j.out'
#SBATCH --partition=P1
...
--output_dir_prefix 'outputs/sentiment/mlm-reranking/roberta-base-yelp-sentiment-classifier-with-gpt2-large-embeds/re/' \
