...
--suffix-length=0  \
--target-type=embeds  \
--tokenizer=gpt2-large:$DATA_DIR/loc_edit/models/roberta-base-yelp-sentiment-classifier-with-gpt2-large-embeds-energy-training/step_44900_best_checkpoint/  \
--topic-target=none  \
