...
#SBATCH --nodelist=n01
#SBATCH --gres=gpu:1
#SBATCH --output='laser_edit/_slurm_outs/s_gbi_mucola_clsf_%j.out'
...
srun python laser_edit/decode_new_for_testset_iter.py \
 ...
 --dampness=0.1\
 --data='laser_edit/data/sentiment/dev_set_below_negative_threshold_827.jsonl'\
 --datastyle='jsonl'\
