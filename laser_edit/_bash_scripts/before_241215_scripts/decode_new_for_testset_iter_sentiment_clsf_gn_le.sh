...
#SBATCH --partition=P2
#SBATCH --gres=gpu:1
#SBATCH --output='laser_edit/_slurm_outs/s_gbi_clsf_gn_%j.out'
...
srun python laser_edit/decode_new_for_testset_iter.py \
 ...
 --dampness=0.1\
 --data='laser_edit/data/sentiment/outputs.txt.init.jsonl'\
 --datastyle='jsonl'\
 ...
 --optim='embedgd_le'\
 --optim-steps=20\
 --output_dir_prefix='outputs/sentiment/roberta-base-yelp-sentiment-classifier-with-gpt2-large-embeds'\
 --output-style='jsonl'\
 --prefix-length=0\
 --random-example='true'\
 ...
 --suffix-length=0\
 --target-type='embeds'\
 --tokenizer='gpt2-large:/shared/s3/lab07/hyeryung/loc_edit/roberta-base-yelp-sentiment-classifier-with-gpt2-large-embeds/step_114500_best_checkpoint'\
 --topic-target='none'\
