...
#SBATCH --gres=gpu:1
#SBATCH --output='laser_edit/_slurm_outs/f_bv0_em_%j.out'
#SBATCH --partition=P1
...
--output_dir_prefix 'outputs/formality/mlm-reranking/roberta-base-pt16-formality-classifier-with-gpt2-large-embeds-energy-training/minor_update' \
