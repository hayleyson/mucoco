...
#SBATCH --partition=P1
#SBATCH --gres=gpu:1
#SBATCH --output='laser_edit/_slurm_outs/f_gbi_mucola_clsf_%j.out'
...
srun python laser_edit/decode_new_for_testset_iter.py \
 ...
 --optim='embedgd_le'\
 --optim-steps=200\
 --output_dir_prefix='outputs/formality/roberta-base-pt16-formality-classifier-with-gpt2-large-embeds/'\
 --output-style='jsonl'\
 --prefix-length=0\
 --random-example='true'\
 ...
 --suffix-length=0\
 --target-type='embeds'\
 --tokenizer='gpt2-large:/shared/s3/lab07/hyeryung/loc_edit/roberta-base-pt16-formality-classifier-with-gpt2-large-embeds/step_1116_best_checkpoint/'\
 --topic-target='none'\
