...
#SBATCH --gres=gpu:1
#SBATCH --output='laser_edit/_slurm_outs/t_gbi_mucola_clsf_%j.out'
...
srun python laser_edit/decode_new_for_testset_iter.py \
 ...
 --dampness=0.1\
 --data='laser_edit/data/toxicity-avoidance/testset_gpt2_2500_below_nontoxic_threshold_468.jsonl'\
 --datastyle='jsonl'\
