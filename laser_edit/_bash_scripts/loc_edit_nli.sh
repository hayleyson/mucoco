...
# --source_data 'laser_edit/data/logical-consistency/anli-r2-test_prompt_4_below_consistent_threshold_3105_sweep_1000.jsonl' \
...
# --task nli \
# --output_dir_prefix 'outputs/nli/' \
# --source_data 'laser_edit/data/logical-consistency/anli-r2-test_prompt_4.jsonl' \
# --source_style 'inconsistent' \
# --target_style 'consistent' \
# --target_label_ids 1 1 \
# --thresholds 0.99 \
...
# --source_data /home/hyeryung/data/mucoco/laser_edit/base_lm_generate/baselm_gens/gpt-3.5-turbo-0125/nli_ifeval/gpt-3.5-turbo-0125_nli_ifeval_150_postprocessed_edit_candidates_0_99.jsonl \
# --source_style inconsistent \
# --target_style consistent \
# --target_label_ids 1 1 \
# --thresholds 0.99 \
