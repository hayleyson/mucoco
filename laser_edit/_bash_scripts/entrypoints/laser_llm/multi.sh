...
#SBATCH --job-name=laser_llm_multi
#SBATCH --output='laser_edit/_slurm_outs/laser_llm_multi_%j.out'
...
# Method: LASER & LLM edit | Task: multi
# Source: llm_edit_main_multi.sh WITHOUT --located_results_file (LASER locate inside edit)

JOB_ID=$SLURM_JOB_ID
DIRECTORY="/home/hyeryung/data/mucoco/outputs/nli_toxicity/llm"
EXP_LABEL="nli_toxicity_masked"
TOTAL_ITERATION=1
...
# Table 13 / §B.4: l=7 for tox & NLI span localization in LaSEr-LLM Edit
MAX_NUM_TOKENS=7
