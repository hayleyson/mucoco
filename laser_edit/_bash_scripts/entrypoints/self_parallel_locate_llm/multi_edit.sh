...
#SBATCH --job-name=spl_multi_edit
#SBATCH --output='laser_edit/_slurm_outs/self_par_multi_edit_%j.out'
...
# Method: Self-parallel-locate & LLM edit | Task: multi | Step: edit
# Source: llm_edit_main_multi.sh (active self-parallel / union located file)
