...
#SBATCH --job-name=plain_multi
#SBATCH --output='laser_edit/_slurm_outs/plain_llm_multi_%j.out'
...
# Method: Plain LLM edit | Task: multi (nli_toxicity)
# Source: llm_edit_baseline_main_multi.sh
...
srun -n 1 -c 1 python laser_edit/llm_edit_baseline_main.py \
$JOB_ID \
--exp_label $EXP_LABEL \
--directory $DIRECTORY \
