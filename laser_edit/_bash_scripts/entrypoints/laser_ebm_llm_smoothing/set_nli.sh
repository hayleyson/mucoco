...
#SBATCH --job-name=refine_snli
#SBATCH --output='laser_edit/_slurm_outs/refine_nli_set_%j.out'
...
# Method: LASER & EBM edit + LLM smoothing | Task: set_nli
...
ORIGINAL_TEXT_PATH="/home/hyeryung/data/mucoco/laser_edit/data/set_nli/testset_incon_300/set_nli_testset_incon_300.jsonl"
INPUT_PATH="/home/hyeryung/data/mucoco/outputs/sc_energy/set_nli/ebm/0cyf2b8p/outputs.txt"
