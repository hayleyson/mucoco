...
#SBATCH --job-name=refine_multi
#SBATCH --output='laser_edit/_slurm_outs/refine_multi_%j.out'
...
# Method: LASER & EBM edit + LLM smoothing | Task: nli_toxicity
# Source: edit/ebm/llm_smoothing/run_refine.sh
# Run AFTER the corresponding laser_ebm/nli_toxicity.sh job finishes.
...
ORIGINAL_TEXT_PATH="/home/hyeryung/data/mucoco/laser_edit/data/nli-toxicity/Qwen3-8B_rewrite_hypothesis_toxic_5shot_test_set_260506.jsonl"
INPUT_PATH="/home/hyeryung/data/mucoco/outputs/nli_toxicity/ebm/f2hjzr5f/outputs.txt"
