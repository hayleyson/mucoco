...
#SBATCH --job-name=refine_lconvqa
#SBATCH --output='laser_edit/_slurm_outs/refine_lconvqa_%j.out'
...
# Method: LASER & EBM edit + LLM smoothing | Task: set_lconvqa
# Source: edit/ebm/llm_smoothing/run_refine.sh
# Run AFTER the corresponding laser_ebm script finishes.
...
ORIGINAL_TEXT_PATH="/home/hyeryung/data/mucoco/laser_edit/data/lconvqa/testset_incon_300/lconvqa_testset_incon_300.jsonl"
INPUT_PATH="/home/hyeryung/data/mucoco/outputs/sc_energy/set_lconvqa/ebm/3f55bsfi/outputs.txt"
