...
#SBATCH --job-name=laser_ebm_multi
#SBATCH --output='laser_edit/_slurm_outs/laser_ebm_multi_%j.out'
...
# Method: LASER & EBM edit | Task: multi
# Source: _bash_scripts/loc_edit_multi_nli_toxicity.sh
...
--source_data /home/hyeryung/data/mucoco/laser_edit/data/nli-toxicity/Qwen3-8B_rewrite_hypothesis_toxic_5shot_test_set_260506.jsonl \
--source_style toxic \
