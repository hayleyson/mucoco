...
#SBATCH --output='laser_edit/_slurm_outs/negative_decoding_%j.out'
...
--source_data '/home/hyeryung/data/mucoco/laser_edit/data/sentiment/gemma_pplm_below_negative_threshold_827.jsonl' \
