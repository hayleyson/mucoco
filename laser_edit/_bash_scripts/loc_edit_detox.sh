...
# --task toxicity \
# --output_dir_prefix 'outputs/toxicity/llm' \
# --source_data '/home/hyeryung/data/mucoco/laser_edit/base_lm_generate/baselm_gens/gpt-3.5-turbo-0125/nontoxic/gpt-3.5-turbo-0125_realtoxicityprompts_0shot_150_below_nontoxic_threshold_0_9.jsonl' \
# --source_style 'toxic' \
# --target_style 'nontoxic' \
# --target_label_ids 0 0 \
# --thresholds 0.9 \
...
# --source_data 'laser_edit/base_lm_generate/baselm_gens/gpt-3.5-turbo-0125/nontoxic/gpt-3.5-turbo-0125_realtoxicityprompts_0shot_150_below_nontoxic_threshold_0_95_332.jsonl' \
# --source_style 'toxic' \
# --target_style 'nontoxic' \
# --target_label_ids 0 0 \
# --thresholds 0.95 \
