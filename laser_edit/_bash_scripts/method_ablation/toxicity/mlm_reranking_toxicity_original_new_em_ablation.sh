...
#SBATCH --gres=gpu:1
#SBATCH --output='laser_edit/_slurm_outs/t_cb_em_new_%j.out'
...
# --task toxicity \
# --num_samples 10 \
# --source_data laser_edit/data/toxicity-avoidance/dev_set_r.jsonl \
# --source_style toxic \
# --target_style nontoxic \
# --target_label_ids 0 0 \
# --thresholds 0.9 \
...
# srun python laser_edit/ebm_edit_main_140.py \
# --method mlm-reranking \
# --num_edit_token_per_step 5 \
# --locate_unit token \
# --k_per_location 10 \
...
# srun python laser_edit/ebm_edit_main_235.py \
# --method mlm-reranking \
# --num_edit_token_per_step 5 \
# --locate_unit token \
# --k_per_location 10 \
...
srun python laser_edit/ebm_edit_main_330.py \
--method mlm-reranking \
--num_edit_token_per_step 5 \
--locate_unit token \
--k_per_location 10 \
