...
#     combi_rerank,
# )
from laser_edit.edit.ebm.decoding_utils import get_beam_hypotheses_v0, get_beam_hypotheses_v1, get_combi_hypotheses, final_reranking
...
def main(config):
    ...
    mlm = None if config["method"] == "mlm-beamsearch-v2" else AutoModelForMaskedLM.from_pretrained("bert-base-uncased").to(config['device'])
