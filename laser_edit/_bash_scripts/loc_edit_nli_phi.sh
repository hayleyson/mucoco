...
--source_data 'laser_edit/data/logical-consistency/phi/filtered_0.99_r2-test_500_Phi-3.5-mini-instruct_49611_postprocess.jsonl' \
...
# --task nli \
# --output_dir_prefix 'outputs/nli/' \
# --source_data 'laser_edit/data/logical-consistency/phi/filtered_0.9_r2-test_500_Phi-3.5-mini-instruct_49611_postprocess.jsonl' \
# --source_style 'inconsistent' \
# --target_style 'consistent' \
# --target_label_ids 1 1 \
# --thresholds 0.9 \
