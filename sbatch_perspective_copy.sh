...
srun python perspective_api_call.py --dpath 'data/toxicity/jigsaw-unintended-bias-in-toxicity-classification/test_1.jsonl' --nsamples 2000 --outpath perspective_result_test_1.csv\
