...
def main(resume, epochs, warmup_steps, learning_rate, weight_decay, logging_steps, eval_steps, evaluation_strategy, save_strategy, save_total_limit, 
    ...
    'test',
    'roberta-base',
    'models_addmore/roberta-base-jigsaw-toxicity-classifier-with-gpt2-large-embeds',
    'gpt2-roberta',
    'full',
    'gpt2-large',
    'freeze-vecmap',
    ...
    train_data = pd.read_json('/home/hyeryungson/mucoco/data/toxicity/jigsaw-unintended-bias-in-toxicity-classification/fine-grained/train_mucoco+addmore.jsonl', lines=True)
    dev_data = pd.read_json('/home/hyeryungson/mucoco/data/toxicity/jigsaw-unintended-bias-in-toxicity-classification/fine-grained/dev_mucoco+addmore.jsonl', lines=True)
    test_data = pd.read_json('/home/hyeryungson/mucoco/data/toxicity/jigsaw-unintended-bias-in-toxicity-classification/fine-grained/test_mucoco+addmore.jsonl', lines=True)
