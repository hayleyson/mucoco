...
#
# Modified by Hayley Son @ SNU GSDS. 23-04-27
# Based on Trainer class implementation in trainer.py of transformers v.4.47.4
#
"""
The Trainer class, to easily train a 🤗 Transformers from scratch or finetune it on a new task.
"""
import wandb # added by Hayley 
import contextlib
import functools
import glob
import inspect
...
from transformers.trainer import logger, skip_first_batches
...
# from transformers.pretok import __version__
...
class CustomTrainer(Trainer):
    ...
    def _inner_training_loop(
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            ############ added by Hayley ############## 
            # at epoch's end, check if succifient time has left for the next epoch.
