...
results_all_time_keys.to_excel(f"new_module/ebm_training/nli/evaluation_results/exp_results_{datetime.datetime.strftime(datetime.datetime.today(), '%Y%m%d')}.xlsx", index=False)
...
# results_all_time_keys = pd.concat(results_all_time_keys)
# results_all_time_keys.to_excel(f"new_module/ebm_training/nli/evaluation_results/nli_energynet_metrics_{datetime.datetime.strftime(datetime.datetime.today(), '%Y%m%d')}.xlsx", index=False)
