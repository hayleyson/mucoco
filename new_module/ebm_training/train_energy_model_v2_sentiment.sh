...
# --max_lr=5e-5 \
# --weight_decay=0.01 \
# --checkpoint_path=/home/hyeryung/data/loc_edit/models/roberta-base-yelp-sentiment-classifier-with-gpt2-large-embeds \
# --max_save_num=3 \
# --training_loss_type=cross_entropy \
# --val_loss_type=mse_loss \
...
--max_lr=5e-5 \
--weight_decay=0.01 \
--checkpoint_path=/home/hyeryung/data/loc_edit/models/roberta-base-yelp-sentiment-classifier-with-gemma2-embeds \
--max_save_num=3 \
--training_loss_type=cross_entropy \
--val_loss_type=mse_loss \
--train_data_path='data/yelp/train_binary.jsonl' \
