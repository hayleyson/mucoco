...
# srun accelerate launch --num_processes=4 new_module/ebm_training/train_energy_model_v2_resume.py \
...
srun accelerate launch --num_processes=1 new_module/ebm_training/train_energy_model_v2_resume.py \
--model=roberta-base-custom \
--model_type=RobertaCustomForSequenceClassification \
--batch_size=56 \
--num_epochs=3 \
