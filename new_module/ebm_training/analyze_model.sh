...
#  --output_dir new_module/ebm_training/roberta-base-jigsaw-toxicity-classifier-energy-training/valid\
#  --batch_size 32
...
#  --test_data_path data/toxicity/jigsaw-unintended-bias-in-toxicity-classification/fine-grained/valid.jsonl\
#  --test_data_type valid\
#  --output_dir new_module/ebm_training/roberta-base-jigsaw-toxicity-classifier/analysis/valid\
#  --batch_size 32
...
#  --test_data_type valid\
#  --output_dir new_module/ebm_training/roberta-base-yelp-sentiment-classifier-energy-training/valid\
#  --batch_size 32
...
#  --test_data_path data/yelp/valid.jsonl\
#  --test_data_type valid\
#  --output_dir new_module/ebm_training/roberta-base-yelp-sentiment-classifier/valid\
#  --batch_size 32
...
#  --test_data_type valid\
#  --output_dir new_module/ebm_training/roberta_large_snli_mnli_anli_train_dev_with_finegrained_finegrained_labels_cross_entropy_n_a/valid\
#  --batch_size 32\
#  --task nli
...
#  --test_data_path data/nli/snli_mnli_anli_train_dev_with_finegrained.jsonl\
#  --test_data_type valid\
#  --output_dir new_module/ebm_training/roberta_large_snli_mnli_anli_train_dev_with_finegrained_binary_labels_binary_cross_entropy_n_a/valid\
#  --batch_size 32\
#  --task nli
...
srun python new_module/ebm_training/analyze_model.py\
 ...
 --test_data_type test\
 --output_dir new_module/ebm_training/roberta-base-irony-energy-model/test\
 --batch_size 32\
 --task irony
...
#  --test_data_path data/ACL-2014-irony/test_binary.jsonl\
#  --test_data_type test\
#  --output_dir new_module/ebm_training/roberta-base-irony-classifier/test\
#  --batch_size 32\
#  --task irony