...
from new_module.utils import constrained_beam_search, score_hypotheses
...
if __name__ == "__main__":
    ...
    # wandb.agent("rhumzmlr", project="my-first-sweep", function=main, count=5)
