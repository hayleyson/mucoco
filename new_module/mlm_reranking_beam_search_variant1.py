...
display_name = f"{config['method']}-{config['locate_unit']}-nps{config['num_edit_token_per_step']}-k{config['k_per_location']}-beam{config['beam_size']}-{config['selection_criteria']}-{config['loss_weights'][0]}-{config['loss_weights'][1]}-wandb-no-normalize"
