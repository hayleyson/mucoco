...
srun python /home/hyeryung/data/mucoco/new_module/llm_experiments/gpt_api_edit_prompted_generation.py \
--openai_api_key $OPENAI_API_KEY \
--file_save_path /home/hyeryung/data/mucoco/new_module/llm_experiments/baselm_gens/gpt4o_editing_gpt2_gens_nontoxic.jsonl \
