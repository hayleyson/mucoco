...
#SBATCH --array=0-3%1
#SBATCH --output='/home/hyeryung/data/mucoco/new_module/llm_experiments/generate_with_llm/logs/%A_%a.out'
...
# --- Shared defaults ---
MAX_NEW_TOKENS=4096
GEN_PY="${ROOT_DIR}/new_module/llm_experiments/generate_with_llm/generate_main.py"
...
FILE_SAVE_DIR="${ROOT_DIR}/new_module/llm_experiments/generate_with_llm/baselm_gens/${MODEL_NAME##*/}/${TASK}"
