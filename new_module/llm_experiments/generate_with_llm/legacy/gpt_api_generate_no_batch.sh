...
# --model "gpt-3.5-turbo-0125" \
# --openai_api_key $OPENAI_API_KEY \
# --file_save_path /home/hyeryung/data/mucoco/new_module/llm_experiments/generate_with_llm/baselm_gens/gpt-3.5-turbo-0125/nontoxic/gpt-3.5-turbo-0125_realtoxicityprompts_0shot_150_for_time.jsonl \
