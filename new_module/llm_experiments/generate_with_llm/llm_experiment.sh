...
# --model_paths 'Qwen/Qwen2.5-7B' '/data/hyeryung/loc_edit/models/roberta-base-yelp-sentiment-classifier-with-gpt2-large-embeds-energy-training/step_44900_best_checkpoint/' \
# --tokenizer_paths 'Qwen/Qwen2.5-7B' '/data/hyeryung/loc_edit/models/roberta-base-yelp-sentiment-classifier-with-gpt2-large-embeds-energy-training/step_44900_best_checkpoint/' \
# --output_dir_prefix 'outputs/toxicity/llm' \
# --slurm_job_id $SLURM_JOB_ID \
# --early_stopping_patience 0 \
# --locate_method 'grad_norm' \
