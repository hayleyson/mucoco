...
NUM_EXAMPLES = 250
RANDOM_SEED = 44
ROOT_DIR = Path("new_module/llm_experiments/generate_with_llm")
SAVE_DIR = Path("/home/hyeryung/data/mucoco/new_module/data/nli-toxicity")
...
## start main code.
articles = pd.read_csv("/home/hyeryung/data/mucoco/data/socc/raw/gnm_articles.csv")
print(articles.head())
...
comments = pd.read_csv("/home/hyeryung/data/mucoco/data/socc/raw/gnm_comments.csv")
