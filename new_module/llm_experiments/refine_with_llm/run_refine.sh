...
# Non-changing values
FEW_SHOT_PATH="${REPO_ROOT}/new_module/llm_experiments/refine_with_llm/few_shot_prompts.json"
...
srun python "${REPO_ROOT}/new_module/llm_experiments/refine_with_llm/refine.py" \
    "${REFINE_ARGS[@]}"
