...
--max_lr=5e-5 \
--weight_decay=0.01 \
--checkpoint_path=/data/hyeryung/loc_edit/models/roberta-base-jigsaw-toxicity-classifier-with-gemma2-embeds \
--max_save_num=1 \
--training_loss_type=cross_entropy \
--val_loss_type=cross_entropy \
--train_data_path='/data/hyeryung/mucoco/data/toxicity/jigsaw-unintended-bias-in-toxicity-classification/fine-grained/train_binary.jsonl' \
--valid_data_path='/data/hyeryung/mucoco/data/toxicity/jigsaw-unintended-bias-in-toxicity-classification/fine-grained/dev_binary.jsonl' \
--wandb_project=toxicity \
--task=toxicity \
--num_validate_steps=100
