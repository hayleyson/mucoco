...
python /data/hyeryung/mucoco/new_module/new_decode_utils_v2_comparing_v0_v1.py --method 0 --num_test_samples 50 --fluency_em_path google/gemma-2-9b
python /data/hyeryung/mucoco/new_module/new_decode_utils_v2_comparing_v0_v1.py --method 1 --num_test_samples 50 --fluency_em_path google/gemma-2-9b
