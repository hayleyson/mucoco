...
# --model_paths 'microsoft/Phi-3.5-mini-instruct' '/data/hyeryung/loc_edit/models/roberta-base-jigsaw-toxicity-classifier-energy-training/step_1000_best_checkpoint' \
# --tokenizer_paths 'microsoft/Phi-3.5-mini-instruct' '/data/hyeryung/loc_edit/models/roberta-base-jigsaw-toxicity-classifier-energy-training/step_1000_best_checkpoint' \
