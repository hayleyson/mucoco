...
# --model_paths 'gpt2-large' '/data/hyeryung/loc_edit/models/clean/roberta-base-yelp-sentiment-classifier-energy-training/step_81900_best_checkpoint' \
# --tokenizer_paths 'gpt2-large' '/data/hyeryung/loc_edit/models/clean/roberta-base-yelp-sentiment-classifier-energy-training/step_81900_best_checkpoint' \
...
--wandb_project 'sentiment-decoding' \
--model_paths 'gpt2-large' '/data/hyeryung/loc_edit/models/clean/roberta-base-yelp-sentiment-classifier/step_83000' \
--tokenizer_paths 'gpt2-large' '/data/hyeryung/loc_edit/models/clean/roberta-base-yelp-sentiment-classifier/step_83000' \
--locate_method 'grad_norm' \
--losses gpt2 classification_no_prefix_logprobloss \
--model_types AutoModelForCausalLM AutoModelForSequenceClassification
