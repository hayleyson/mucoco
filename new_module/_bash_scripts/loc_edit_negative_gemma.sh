...
#SBATCH --output='new_module/_slurm_outs/negative_decoding_%j.out'
...
--source_data '/home/hyeryung/data/mucoco/new_module/data/sentiment/gemma_pplm_below_negative_threshold_827.jsonl' \
