...
--thresholds 0.75 \
--wandb_project 'toxicity-decoding' \
--model_paths 'gpt2-large' '/home/hyeryung/data/loc_edit/models/roberta-base-jigsaw-toxicity-classifier/step_500_best_checkpoint/' \
--tokenizer_paths 'gpt2-large' '/home/hyeryung/data/loc_edit/models/roberta-base-jigsaw-toxicity-classifier/step_500_best_checkpoint/' \
--output_dir_prefix 'outputs/toxicity/final/clsf' \
--slurm_job_id $SLURM_JOB_ID \
--early_stopping_patience 0 \
--locate_method 'grad_norm' \
