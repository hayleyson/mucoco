...
# --min_epsilons 0.704521 \
# --wandb_project 'formality-decoding' \
# --model_paths 'gpt2-large' '/data/hyeryung/loc_edit/models/roberta-base-pt16-formality-classifier/step_558_best_checkpoint/' \
# --tokenizer_paths 'gpt2-large' '/data/hyeryung/loc_edit/models/roberta-base-pt16-formality-classifier/step_558_best_checkpoint/' \
...
# --min_epsilons 0.75 \
# --wandb_project 'formality-decoding' \
# --model_paths 'gpt2-large' '/data/hyeryung/loc_edit/models/roberta-base-pt16-formality-classifier-with-gpt2-large-embeds/step_1116_best_checkpoint/' \
# --tokenizer_paths 'gpt2-large' '/data/hyeryung/loc_edit/models/roberta-base-pt16-formality-classifier-with-gpt2-large-embeds/step_1116_best_checkpoint/' \
# --locate_method 'grad_norm' \
# --losses gpt2 classification_no_prefix_logprobloss \
# --model_types AutoModelForCausalLM AutoModelForSequenceClassification
