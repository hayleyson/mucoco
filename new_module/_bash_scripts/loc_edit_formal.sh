...
--model_paths 'gpt2-large' '/data/hyeryung/loc_edit/models/clean/roberta-base-pt16-formality-classifier-energy-training/step_1120_best_checkpoint/' \
--tokenizer_paths 'gpt2-large' '/data/hyeryung/loc_edit/models/clean/roberta-base-pt16-formality-classifier-energy-training/step_1120_best_checkpoint/' \
