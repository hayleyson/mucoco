...
from new_module.losses.base_loss import BaseLoss
from new_module.losses.model_wrapper import ModelWrapper
...
for file in os.listdir(losses_dir):
    ...
    if (
        ...
        module = importlib.import_module("new_module.losses." + loss_name)
