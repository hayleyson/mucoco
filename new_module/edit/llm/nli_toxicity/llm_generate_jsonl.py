...
from new_module.edit.llm_edit.prompts import get_prompt
from new_module.set_consistency_energy.baselines.LLM.lm_loader import lm_loader
from new_module.utils.utils import parse_set_text, convert_format
...
def generate_and_save_result(args):
    ...
    #     orig_text_path = "/home/saeheeeom/data/set_consistency/mucoco/new_module/base_lm_generate/baselm_gens/gpt-3.5-turbo-0125/nontoxic/gpt-3.5-turbo-0125_realtoxicityprompts_0shot_150.jsonl"
    # else:
    #     orig_text_path = '/data3/saeheeeom/set_consistency/mucoco/new_module/base_lm_generate/baselm_gens/gpt-3.5-turbo-0125/nontoxic/gpt-3.5-turbo-0125_realtoxicityprompts_noprompt_150.jsonl'
