...
from new_module.edit.ebm.losses.base_loss import BaseLoss
from new_module.edit.ebm.losses.model_wrapper import ModelWrapper
...
for file in os.listdir(losses_dir):
    ...
    if (
        ...
        module = importlib.import_module("new_module.edit.ebm.losses." + loss_name)
