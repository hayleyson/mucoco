...
from .locate_modules.locate_by_token_scores import locate_by_gradnorm, locate_by_attention
...
class locate(nn.Module):
    ...
    def initialize(self, energynet):
        ...
        elif self.locate_type == 'attention':
            self.locate_method = locate_by_attention(self.params, energynet)
            print("locate by attention")
    ...
    def forward(self, inputs):
        ...
        # aim: 주어진 pair에 대해서 in-consistent 할 것 같은 example을 detect한다.
