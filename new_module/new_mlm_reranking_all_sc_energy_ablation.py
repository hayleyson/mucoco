...
def main(config):
    ...
    if config['configuration'] in [1,2,3,4]:
        consider_sc_energy_inner_beam=True
    elif config['configuration'] in [5,6,7,8]:
        consider_sc_energy_inner_beam=False

    if config['configuration'] in [1,2,5,6]:
        consider_lefthand_instance_for_fluency_inner_beam=True
    elif config['configuration'] in [3,4,7,8]:
        consider_lefthand_instance_for_fluency_inner_beam=False
    
    if config['configuration'] in [1,3,5,7]:
        consider_lefthand_instance_for_fluency=True
    elif config['configuration'] in [2,4,6,8]:
                ...
                if len(span_lengths) > 0:
                    ...
                    final_hypotheses_curr, new_best_weighted_loss_curr, new_best_allsat_curr, new_best_logging_loss_curr = \
                                editing_4sce(source_text, 
                                    ...
                                    consider_lefthand_instance_for_fluency=consider_lefthand_instance_for_fluency,
                                    consider_lefthand_instance_for_fluency_inner_beam=consider_lefthand_instance_for_fluency_inner_beam,
                                    consider_sc_energy_inner_beam=consider_sc_energy_inner_beam)
