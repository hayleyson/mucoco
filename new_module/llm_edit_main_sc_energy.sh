...
INPUT_FILE_PATH="new_module/data/set_nli/testset_incon_300/set_nli_testset_incon_300.jsonl"
ORIG_TEXT_PATH="new_module/data/set_nli/testset_incon_300/set_nli_testset_incon_300.jsonl"

PRETRAINED_MODEL_PATH="/home/hyeryung/data/mucoco/new_module/set_consistency_energy/params_set_nli.yaml"
...
srun python new_module/llm_edit_main_sc_energy.py \
$JOB_ID \
--exp_label $EXP_LABEL \
--directory $DIRECTORY \
