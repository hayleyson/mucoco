...
df1 = pd.read_csv('/home/hyeryung/data/mucoco/new_module/locate/evaluation_results/evaluation_summary.csv')
df2 = pd.read_csv('/home/hyeryung/data/mucoco/new_module/llm_experiments/locate_with_llm/evaluation_results/evaluation_summary.csv')
...
for task in tasks:
    ...
    plt.tight_layout()
    plt.savefig(f'/home/hyeryung/data/mucoco/new_module/locate/analyze_results/execution_time_vs_f1_{task}.png', dpi=300, bbox_inches='tight')
    plt.close()
...
for task in tasks:
    ...
    plt.tight_layout()
    plt.savefig(f'/home/hyeryung/data/mucoco/new_module/locate/analyze_results/precision_vs_recall_{task}.png', dpi=300, bbox_inches='tight')
    plt.close()
...
output_csv_path = '/home/hyeryung/data/mucoco/new_module/locate/analyze_results/processed_results.csv'
