        ...
        for sample_idx in range(config['num_samples'])[:]:
            ...
            if allsat:
                ...
                for _iter in range(wandb.config.n_iter):
                    ...
                    # hypotheses = constrained_beam_search(source_batch, masked_sequence, torch.LongTensor(sorted(indices[0])), primary_mask_token_id, predicted_token_ids, primary_tokenizer, mlm_tokenizer, primary_model, config, beam_size = wandb.config.beam_size)
