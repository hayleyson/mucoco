...
def get_beam_4sce(source_text:str, 
    ...
    if not return_all_hypotheses: ## 밖에서 reranking을 하는 경우가 아니라면 deletion 케이스도 처리
        ...
        tmp_hypotheses_dec = [hyp + post_context for hyp in tmp_hypotheses_dec]
    ...
    if return_all_hypotheses:
        ...
        return [mlm_tokenizer.batch_decode(x) for x in final_final_hypotheses], final_final_scores
